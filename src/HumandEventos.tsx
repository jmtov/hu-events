...
export default function App() {
  ...
  const classify = async () => {
    ...
    try {
      ...
      setError(
        'Erro ao classificar o evento. Verifique a descrição e tente novamente.',
      );
    } finally {
      setLoading(false);
    }
  ...
  const typeStyle = result
    ? TYPE_STYLES[result.event_type as keyof typeof TYPE_STYLES] ||
      TYPE_STYLES.Outro
    : TYPE_STYLES.Outro;
  const locIcon = result
    ? LOC_ICONS[result.location_type as keyof typeof LOC_ICONS] || '📌'
    : '📌';
      ...
      <div style={{ maxWidth: 600, margin: '0 auto' }}>
        <div style={{ marginBottom: 28, textAlign: 'center' }}>
          ...
          <p style={{ color: '#64748b', fontSize: 14, margin: 0 }}>
            Classificador inteligente de eventos corporativos
          </p>
        </div>
        ...
        >
          ...
          <div style={{ display: 'flex', gap: 10, marginTop: 14 }}>
            ...
            >
              {loading ? 'Classificando...' : '✨ Classificar Evento'}
            </button>
            {(result || description) && (
              <button
                onClick={reset}
          ...
          >
            {isInvalid ? (
              ...
              <div style={{ textAlign: 'center', padding: '12px 0 4px' }}>
                ...
                >
                  Não conseguimos identificar um evento válido nesta descrição.
                  <br />
                  ...
                  >
                    ...
                    <p
                      style={{
                        ...
                        fontSize: 13,
                        fontWeight: 600,
                        color: result!.is_travel_required
                          ? '#0369a1'
                          : '#334155',
                      }}
                    >
                      {result!.is_travel_required
                        ? 'Necessária'
                        : 'Não necessária'}
                    </p>
                  </div>
